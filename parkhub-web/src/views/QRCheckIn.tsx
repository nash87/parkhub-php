...
export function QRCheckInPage() {
  ...
  return (
    ...
    >
      <motion.div
        variants={fadeUp}
        className={`overflow-hidden rounded-lg border px-6 py-6 shadow-[0_24px_70px_-42px_rgba(15,23,42,0.45)] ${
          isVoid
        ...
        <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-5">
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <h1 className="text-3xl font-black tracking-normal">{t('checkin.title')}</h1>
      ...
      {/* No active booking */}
      {!booking && (
        <motion.div variants={fadeUp} className={`rounded-lg border p-12 text-center ${
          isVoid
      ...
      {booking && (
        <>
          <div className="grid gap-5 xl:grid-cols-[1.05fr_0.95fr]">
            <motion.div variants={fadeUp} className={`rounded-lg border p-5 ${
              isVoid
                ? 'border-slate-800 bg-slate-950/85 text-white'
                : 'border-surface-200 bg-white text-surface-900 shadow-[0_18px_50px_-38px_rgba(15,23,42,0.18)] dark:border-surface-800 dark:bg-surface-950/80 dark:text-white'
            }`}>
              ...
              <div className="mt-5 grid grid-cols-2 gap-3">
                <div className={`rounded-lg border p-4 ${isVoid ? 'border-white/10 bg-white/[0.04]' : 'border-surface-100 bg-surface-50 dark:border-surface-800 dark:bg-surface-900/70'}`}>
            ...
            {checkInStatus && !checkInStatus.checked_in && (
              <motion.div variants={fadeUp} className={`rounded-lg border p-6 flex flex-col items-center ${
                isVoid
                  ? 'border-slate-800 bg-slate-950/85 text-white'
                  : 'border-surface-200 bg-white text-surface-900 shadow-[0_18px_50px_-38px_rgba(15,23,42,0.18)] dark:border-surface-800 dark:bg-surface-950/80 dark:text-white'
              }`}>
                {qrUrl && (
                  <img
                    src={qrUrl}
                    alt={t('checkin.qrAlt')}
                    className="w-56 h-56 rounded-lg border border-surface-200 bg-white p-3 dark:border-surface-700"
                    data-testid="qr-code"
                  />
                )}
            ...
            {checkInStatus?.checked_in && !checkInStatus.checked_out_at && (
              <>
                <motion.div variants={fadeUp} className={`rounded-lg border p-6 text-center ${
                  isVoid
                  ...
                  <p className="mb-2 text-xs font-medium uppercase tracking-normal text-surface-400 dark:text-surface-500">
                    {t('checkin.elapsed')}
                  </p>
