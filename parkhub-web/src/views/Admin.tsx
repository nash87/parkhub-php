  ...
  return [
    {
      ...
      items: [
        { key: 'overview', label: t('admin.overview', 'Overview'), to: '/admin', icon: ChartBar },
            ...
            {section.items.map(item => {
              ...
              const content = (
                <>
                  ...
                  {item.external && <ArrowSquareOut weight="regular" className="h-3.5 w-3.5 shrink-0 text-surface-400" />}
                </>
              );
