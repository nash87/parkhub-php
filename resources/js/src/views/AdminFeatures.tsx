  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      ...
      <motion.div variants={item}>
        <Link to="/" className="inline-flex items-center gap-2 text-xs text-surface-500 hover:text-accent-600 mb-4 transition-colors cursor-pointer uppercase tracking-normalr font-semibold">
          <ArrowLeft weight="bold" className="w-3.5 h-3.5" /> {t('nav.dashboard')}
        </Link>
        <p className="text-xs font-semibold text-accent-600 dark:text-accent-400 uppercase tracking-normalst mb-1">
          {t('nav.admin')}
        </p>
      ...
      {grouped.map(({ category, modules }, gi) => (
        ...
        >
          <div className="px-4 py-2.5 bg-surface-50 dark:bg-surface-800/50 border-b border-surface-200/50 dark:border-surface-700/50">
            <span className="text-[10px] font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-normalst">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-[9px] font-semibold uppercase tracking-normalr px-1.5 py-0.5 transition-colors ${
                          enabled
      ...
      <motion.div variants={item} className="card p-4 border-l-3 border-l-emerald-500">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-surface-900 dark:text-white uppercase tracking-normalr mb-1.5">
