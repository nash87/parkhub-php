          ...
          {step === 'usecase' ? (
            ...
            >
              ...
              <button
                ...
                className="mt-4 text-xs text-surface-400 hover:text-surface-600 dark:hover:text-surface-300 transition-colors cursor-pointer uppercase tracking-normalr"
              >
                {t('useCase.skip')}
              </button>
            </motion.div>
