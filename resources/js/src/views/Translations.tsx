    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="rounded-lg bg-red-50 dark:bg-red-900/10 border border-red-200/40 dark:border-red-800/30 p-3">
          <p className="text-[10px] font-semibold text-red-500 dark:text-red-400 uppercase tracking-normalr mb-1">{t('translations.current')}</p>
        ...
        <div className="rounded-lg bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-200/40 dark:border-emerald-800/30 p-3">
          <p className="text-[10px] font-semibold text-emerald-500 dark:text-emerald-400 uppercase tracking-normalr mb-1">{t('translations.proposed')}</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-surface-200 dark:border-surface-700">
                  <th className="text-left px-5 py-3 text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-normalr">{t('translations.keyLabel')}</th>
                  <th className="text-left px-5 py-3 text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-normalr">{t('translations.value')}</th>
                  <th className="text-right px-5 py-3 text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-normalr"></th>
                </tr>
              </thead>
