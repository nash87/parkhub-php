        ...
        [
            ...
            'config_schema' => [
                ...
                'properties' => [
                    ...
                    'pipeline_endpoint' => [
                        'type' => 'string',
                        'description' => 'Optional local or cluster fop-pipeline base URL, for example http://fop-pipeline.fop-agents.svc:9310. External hosts are rejected by the adapter allowlist.',
                    ],
                    'pipeline_name' => [
                        'type' => 'string',
                        'minLength' => 1,
                    ...
                    'weight_accessibility_bonus' => [
                        ...
                        'minimum' => 0,
                        'maximum' => 25,
                        'description' => 'Optional extra points for facility-designated accessible slots only. Must not use inferred disability, health, or other sensitive user attributes; keep at 0 until tenant DPIA/privacy review and user-facing notice approve it.',
                    ],
                    'weight_feature_bonus' => [
                        'type' => 'number',
                        'minimum' => 0,
